...
tape( 'the function tests whether at least one element in a 0-dimensional ndarray is truthy', function test( t ) {
	var actual;
	var x;
...
tape( 'the function tests whether at least one element in a 0-dimensional ndarray is truthy (accessors)', function test( t ) {
	var actual;
	var x;
...
tape( 'the function tests whether at least one element in a 0-dimensional ndarray is truthy (complex)', function test( t ) {
	var actual;
	var x;
